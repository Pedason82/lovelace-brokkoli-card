...
(()=>{"use strict";var t={489:function(t,e,i){var n=this&&this.__decorate||function(t,e,i,n){var r,o=arguments.length,a=o<3?e:null===n?n=Object.getOwnPropertyDescriptor(e,i):n;if("object"==typeof Reflect&&"function"==typeof Reflect.decorate)a=Reflect.decorate(t,e,i,n);else for(var s=t.length-1;s>=0;s--)(r=t[s])&&(a=(o<3?r(a):o>3?r(e,i,a):r(e,i))||a);return o>3&&a&&Object.defineProperty(e,i,a),a},r=this&&this.__awaiter||function(t,e,i,n){return new(i||(i=Promise))((function(r,o){function a(t){try{l(n.next(t))}catch(t){o(t)}}function s(t){try{l(n.throw(t))}catch(t){o(t)}}function l(t){var e;t.done?r(t.value):(e=t.value,e instanceof i?e:new i((function(t){t(e)}))).then(a,s)}l((n=n.apply(t,e||[])).next())}))};Object.defineProperty(e,"__esModule",{value:!0});const o=i(437),a=i(924),s=i(800),l=i(772),d=i(330),c=i(442),u=i(754),p=i(265),h=i(48),m=i(63),g=i(358),f=i(361);i(242),i(507),console.info(`%c BROKKOLI-LIST-CARD %c ${d.version}`,"color: cyan; background: black; font-weight: bold;","color: darkblue; background: white; font-weight: bold;"),window.customCards=window.customCards||[],window.customCards.push({type:"brokkoli-list-card",name:"Brokkoli List Card",preview:!0,description:"Eine tabellarische Übersicht aller Pflanzen"});let v=class extends o.LitElement{constructor(){super(...arguments),this._showPlantDialog=!1,this._dialogPosition={x:0,y:0},this._lastSelectedEntityId=null,this.plantEntities=[],this.EDITABLE_PLANT_ATTRIBUTES=u.ConfigUtils.EDITABLE_PLANT_ATTRIBUTES}static getStubConfig(){return u.ConfigUtils.getDefaultConfig()}setConfig(t){this.config=Object.assign(Object.assign({},u.ConfigUtils.getDefaultConfig()),t),this.stateManager&&this.stateManager.updateConfig(this.config)}set hass(t){this._hass=t,!this.stateManager&&t&&(this.stateManager=new f.StateManager(t,this.config,(()=>this.requestUpdate()))),this.plantEntities.length?this._refreshExistingEntities():this.updatePlantEntities()}_refreshExistingEntities(){return r(this,void 0,void 0,(function*(){if(!this._hass)return;let t=!1;for(let e=0;e<this.plantEntities.length;e++){const i=this.plantEntities[e],n=yield m.PlantEntityUtils.getPlantInfo(this._hass,i.entity_id);if(n&&(!i.attributes._apiInfo||JSON.stringify(i.attributes._apiInfo)!==JSON.stringify(n))){const r=this._buildSensorMap(n);this.plantEntities[e]=Object.assign(Object.assign({},i),{attributes:Object.assign(Object.assign({},i.attributes),{_sensorMap:r,_apiInfo:n})}),t=!0}}t&&this.requestUpdate()}))}_buildSensorMap(t){if(!t)return{};const e={};for(const i in t)t[i]&&"object"==typeof t[i]&&t[i].sensor&&(e[{moisture:"soil_moisture",humidity:"air_humidity",ph:"ph"}[i]||i]=t[i].sensor);if(t.diagnostic_sensors)for(const i in t.diagnostic_sensors)t.diagnostic_sensors[i]&&t.diagnostic_sensors[i].entity_id&&(e[{moisture:"soil_moisture",humidity:"air_humidity",total_integral:"total_ppfd_mol_integral",total_water:"total_water_consumption",total_fertilizer:"total_fertilizer_consumption"}[i]||i]=t.diagnostic_sensors[i].entity_id);if(t.helpers)for(const i in t.helpers)t.helpers[i]&&t.helpers[i].entity_id&&(e[i]=t.helpers[i].entity_id);return e}updatePlantEntities(){return r(this,void 0,void 0,(function*(){if(!this._hass)return;const t=m.PlantEntityUtils.getPlantEntities(this._hass);m.PlantEntityUtils.initPlantDataLoading(this._hass,t.map((t=>t.entity_id)));const e=[];for(const i of t)try{const t=yield m.PlantEntityUtils.getPlantInfo(this._hass,i.entity_id),n=this._buildSensorMap(t),r=Object.assign(Object.assign({},i),{attributes:Object.assign(Object.assign({},i.attributes),{_sensorMap:n,_apiInfo:t})});e.push(r)}catch(t){console.error(`[BROKKOLI-LIST] Fehler beim Anreichern von ${i.entity_id}:`,t),e.push(i)}this.plantEntities=e,this.requestUpdate()}))}getVisibleColumns(){return u.ConfigUtils.getVisibleColumns(this.config)}_handleAddPlant(){this._showPlantDialog=!0,this._dialogPosition={x:50,y:50},this.requestUpdate()}_handleDialogClosed(){this._showPlantDialog=!1,this.requestUpdate(),this.updatePlantEntities()}connectedCallback(){super.connectedCallback(),this.addEventListener("flower-image-click",this._handleFlowerImageClick.bind(this))}disconnectedCallback(){super.disconnectedCallback(),this.removeEventListener("flower-image-click",this._handleFlowerImageClick.bind(this)),m.PlantEntityUtils.clearAllTimeouts()}_handleFlowerImageClick(t){if(!this.stateManager)return;const e=t.detail.entityId;e&&this.stateManager.handleGalleryOpen(e)}_handleRowClick(t,e){var i;if(t.target.closest(".clickable"))return;if(!this.stateManager)return;if(this.stateManager.getState().multiSelectMode)return;const n=this._lastSelectedEntityId===e.entity_id;if(this._lastSelectedEntityId=n?null:e.entity_id,null===(i=this.config)||void 0===i?void 0:i.identifier){const t=new CustomEvent("flower-card-entity-selected",{bubbles:!0,composed:!0,detail:{sourceIdentifier:this.config.identifier,selectedEntityId:this._lastSelectedEntityId}});window.dispatchEvent(t)}}render(){var t,e,i,n,r,a;if(!this._hass||!this.stateManager)return o.html``;const s=this.stateManager.getState(),l=h.SortUtils.getSortedPlants(c.FilterUtils.getFilteredPlants(this._hass,this.plantEntities,s.filterState,s.searchQuery,this.EDITABLE_PLANT_ATTRIBUTES),s.sortColumn,s.sortDirection,this._hass),d=this.getVisibleColumns(),u=!1!==(null===(e=null===(t=this.config)||void 0===t?void 0:t.add_plant)||void 0===e?void 0:e.enabled),m=(null===(n=null===(i=this.config)||void 0===i?void 0:i.add_plant)||void 0===n?void 0:n.position)||"bottom";return o.html`
            <div class="card-container">
                <ha-card>
                    ...
                    ${s.filterMode?p.BrokkoliListComponents.renderFilterSidebar(d,s.filterState,(t=>this.stateManager.toggleEntityType(t)),((t,e)=>this.stateManager.toggleFilter(t,e)),this._hass,this.plantEntities):""}

                    <div class="table-container${s.filterMode?" filtered":""}">
                        <table>
                            ${p.BrokkoliListComponents.renderTableHeader(d,s.multiSelectMode,s.sortColumn,s.sortDirection,(t=>this.stateManager.handleSort(t)))}
                            <tbody>
                                ${u&&"top"===m?p.BrokkoliListComponents.renderAddPlantButton((()=>this._handleAddPlant())):""}
                                ${l.map((t=>p.BrokkoliListComponents.renderTableRow(t,d,s.multiSelectMode,s.selectedPlants,((t,e)=>this.stateManager.togglePlantSelection(t,e)),((t,e,i)=>this.stateManager.handleCellClick(t,e,i,this.dispatchEvent.bind(this))),((t,e)=>this._handleRowClick(t,e)),(t=>this.stateManager.getCursorStyle(t)),((t,e)=>g.CellRenderer.renderCell({hass:this._hass,plant:t,columnId:e,editingCell:s.editingCell,onCellClick:i=>this.stateManager.handleCellClick(i,t,e,this.dispatchEvent.bind(this)),onInputUpdate:(i,n)=>this.stateManager.handleInputUpdate(i,t,e,n),onRowClick:e=>this._handleRowClick(e,t)})))))}
                                ${u&&"bottom"===m?p.BrokkoliListComponents.renderAddPlantButton((()=>this._handleAddPlant())):""}
                            </tbody>
                        </table>
                    </div>
                </ha-card>
            ...
            ${this._lastSelectedEntityId&&"add-plant"!==this._lastSelectedEntityId?o.html`
                <brokkoli-gallery
                    .hass=${this._hass}
                    .entityId=${this._lastSelectedEntityId}
                    .onClose=${()=>{this._lastSelectedEntityId=null}}
                ></brokkoli-gallery>
            `:""}
        `}getCardSize(){return 1+Math.ceil(this.plantEntities.length/2)}static get styles(){return[s.style,l.flowerListStyle]}};n([(0,a.property)()],v.prototype,"_hass",void 0),n([(0,a.property)()],v.prototype,"config",void 0),n([(0,a.state)()],v.prototype,"_showPlantDialog",void 0),n([(0,a.state)()],v.prototype,"_dialogPosition",void 0),n([(0,a.state)()],v.prototype,"_lastSelectedEntityId",void 0),v=n([(0,a.customElement)("brokkoli-list-card")],v),e.default=v},507:function(t,e,i){var n=this&&this.__decorate||function(t,e,i,n){var r,o=arguments.length,a=o<3?e:null===n?n=Object.getOwnPropertyDescriptor(e,i):n;if("object"==typeof Reflect&&"function"==typeof Reflect.decorate)a=Reflect.decorate(t,e,i,n);else for(var s=t.length-1;s>=0;s--)(r=t[s])&&(a=(o<3?r(a):o>3?r(e,i,a):r(e,i))||a);return o>3&&a&&Object.defineProperty(e,i,a),a},r=this&&this.__awaiter||function(t,e,i,n){return new(i||(i=Promise))((function(r,o){function a(t){try{l(n.next(t))}catch(t){o(t)}}function s(t){try{l(n.throw(t))}catch(t){o(t)}}function l(t){var e;t.done?r(t.value):(e=t.value,e instanceof i?e:new i((function(t){t(e)}))).then(a,s)}l((n=n.apply(t,e||[])).next())}))};Object.defineProperty(e,"__esModule",{value:!0}),e.FlowerGallery=void 0;const o=i(437),a=i(924),s=i(534),l=i(364),d=i(63);class c extends o.LitElement{constructor(){super(...arguments),this.images=[],this._currentImageIndex=0,this._isFading=!1,this._showFlyout=!1,this._showDeleteFlyout=!1,this._showMainImageFlyout=!1,this._reparentedToBody=!1,this._plantInfo=null,this._isLoading=!1,this._imagesList=[],this._isImagesLoading=!1}_changeImage(){return r(this,arguments,void 0,(function*(t="next"){this._isFading=!0,this.requestUpdate(),yield new Promise((t=>setTimeout(t,500))),this._currentImageIndex="next"===t?(this._currentImageIndex+1)%this.images.length:(this._currentImageIndex-1+this.images.length)%this.images.length,this._isFading=!1,this.requestUpdate()}))}_selectImage(t){return r(this,void 0,void 0,(function*(){t!==this._currentImageIndex&&(this._isFading=!0,this.requestUpdate(),yield new Promise((t=>setTimeout(t,500))),this._currentImageIndex=t,this._isFading=!1,this.requestUpdate())}))}_toggleFlyout(t){t.preventDefault(),t.stopPropagation(),this._showFlyout=!this._showFlyout}_toggleDeleteFlyout(t){t.preventDefault(),t.stopPropagation(),this._showDeleteFlyout=!this._showDeleteFlyout}_toggleMainImageFlyout(t){t.preventDefault(),t.stopPropagation(),this._showMainImageFlyout=!this._showMainImageFlyout}_handleFileUpload(t){return r(this,void 0,void 0,(function*(){const e=t.target.files;if(e&&e.length>0){const t=e[0];if(!t.type.startsWith("image/"))return void alert("Bitte nur Bilder hochladen!");if(t.size>10485760)return void alert("Bild ist zu groß! Maximale Größe ist 10MB.");try{yield this._uploadImage(t),this._showFlyout=!1}catch(t){alert("Fehler beim Upload: "+t.message)}}}))}_uploadImage(t){return r(this,void 0,void 0,(function*(){if(!this.entityId||!this.hass)return;const e=16384,i=new FileReader;i.onload=i=>r(this,void 0,void 0,(function*(){var n;if(!(null===(n=i.target)||void 0===n?void 0:n.result))return;const r=i.target.result,o=Math.ceil(r.byteLength/e);for(let i=0;i<o;i++){const n=r.slice(i*e,(i+1)*e),a=Array.from(new Uint8Array(n)).map((t=>t.toString(16).padStart(2,"0"))).join("");try{yield this.hass.connection.sendMessagePromise({type:"plant/upload_image",entity_id:this.entityId,filename:t.name,chunk:a,chunk_index:i,total_chunks:o})}catch(t){throw console.error("Upload error:",t),t}}yield this.hass.callService("homeassistant","update_entity",{entity_id:this.entityId})})),i.readAsArrayBuffer(t)}))}_deleteImage(t){return r(this,void 0,void 0,(function*(){if(this.entityId&&this.hass)try{yield this.hass.connection.sendMessagePromise({type:"plant/delete_image",entity_id:this.entityId,filename:t}),yield this.hass.callService("homeassistant","update_entity",{entity_id:this.entityId})}catch(t){throw new Error(`Fehler beim Löschen des Bildes: ${t.message}`)}}))}_setMainImage(t){return r(this,void 0,void 0,(function*(){if(this.entityId&&this.hass)try{yield this.hass.connection.sendMessagePromise({type:"plant/set_main_image",entity_id:this.entityId,filename:t}),yield this.hass.callService("homeassistant","update_entity",{entity_id:this.entityId})}catch(t){throw new Error(`Fehler beim Setzen des Hauptbildes: ${t.message}`)}}))}_close(t){t.stopPropagation(),this._imageRotationInterval&&clearInterval(this._imageRotationInterval),this.onClose&&this.onClose(),this.remove()}_loadPlantInfo(){return r(this,void 0,void 0,(function*(){if(this.entityId&&this.hass&&!this._isLoading){this._isLoading=!0;try{this._plantInfo=yield d.PlantEntityUtils.getPlantInfo(this.hass,this.entityId),yield this._initGallery()}catch(t){console.warn("Fehler beim Laden der Pflanzen-Info:",t),this._plantInfo=null}finally{this._isLoading=!1}}}))}_initGallery(){return r(this,void 0,void 0,(function*(){if(this.entityId&&this.hass&&this._plantInfo&&!this._isImagesLoading){this._isImagesLoading=!0;try{this._imagesList=yield c.getImagesWithDates(this.hass,this.entityId,this._plantInfo),0===this.images.length&&(this.images=this._imagesList.map((t=>t.url))),this.requestUpdate()}catch(t){console.warn("Fehler beim Laden der Bilder:",t)}finally{this._isImagesLoading=!1}}}))}connectedCallback(){super.connectedCallback(),this.parentElement!==document.body&&(document.body.appendChild(this),this._reparentedToBody=!0),void 0!==this.initialImageIndex&&(this._currentImageIndex=this.initialImageIndex),this.images.length>1&&(this._imageRotationInterval=setInterval((()=>{this._changeImage()}),1e4)),this._loadPlantInfo()}disconnectedCallback(){super.disconnectedCallback(),this._imageRotationInterval&&clearInterval(this._imageRotationInterval)}static get styles(){return l.galleryStyles}static getImageDateFromUrl(t){const e=t.match(/_(\d{8}_\d{6})/);if(!e)return null;const i=e[1],n=i.slice(0,4),r=i.slice(4,6),o=i.slice(6,8),a=i.slice(9,11),s=i.slice(11,13);return new Date(`${n}-${r}-${o}T${a}:${s}:00`)}static getImagesWithDates(t,e,i){return r(this,void 0,void 0,(function*(){const n=t.states[e];if(!(null==n?void 0:n.attributes.images))return[];const r=n.attributes.download_path||"/local/images/plants/",o=[];if(n.attributes.entity_picture){let r;r=i?yield this.getFirstPhaseDate(t,e,i):yield this.getFirstPhaseDate(t,e),r&&o.push({url:n.attributes.entity_picture,date:r})}return n.attributes.images.forEach((t=>{const e=this.getImageDateFromUrl(t);e&&o.push({url:`${r}${t}`,date:e})})),o.sort(((t,e)=>t.date.getTime()-e.date.getTime()))}))}static getFirstPhaseDate(t,e,i){return r(this,void 0,void 0,(function*(){var n,r,o,a;if(i){if(!(null===(r=null===(n=null==i?void 0:i.helpers)||void 0===n?void 0:n.growth_phase)||void 0===r?void 0:r.entity_id))return null;const e=i.helpers.growth_phase.entity_id,o=t.states[e];if(!o)return null;const a=["samen","keimen","wurzeln","wachstum","blüte","entfernt","geerntet"];for(const t of a){const e=o.attributes[`${"entfernt"===t||"geerntet"===t?t:t+"_beginn"}`];if(e)return new Date(e)}return null}try{const i=yield d.PlantEntityUtils.getPlantInfo(t,e);if(!(null===(a=null===(o=null==i?void 0:i.helpers)||void 0===o?void 0:o.growth_phase)||void 0===a?void 0:a.entity_id))return null;const n=i.helpers.growth_phase.entity_id,r=t.states[n];if(!r)return null;const s=["samen","keimen","wurzeln","wachstum","blüte","entfernt","geerntet"];for(const t of s){const e=r.attributes[`${"entfernt"===t||"geerntet"===t?t:t+"_beginn"}`];if(e)return new Date(e)}return null}catch(t){return console.warn("Fehler beim Laden der Pflanzen-Info für getFirstPhaseDate:",t),null}}))}_getGroupedImages(){var t,e,i,n;if(!this.entityId||!this.hass||!this._plantInfo)return[];if(!(null===(i=null===(e=null===(t=this._plantInfo)||void 0===t?void 0:t.helpers)||void 0===e?void 0:e.growth_phase)||void 0===i?void 0:i.entity_id))return[];const r=this._plantInfo.helpers.growth_phase.entity_id,o=this.hass.states[r];if(!o)return[];const a=["samen","keimen","wurzeln","wachstum","blüte","geerntet","entfernt"],s={samen:"Samen",keimen:"Keimen",wurzeln:"Wurzeln",wachstum:"Wuchs",blüte:"Blüte",geerntet:"Geerntet",entfernt:"Entfernt"},l=[];let d="",c=[];const u=a.filter((t=>null!=o.attributes[`${"entfernt"===t||"geerntet"===t?t:t+"_beginn"}`]));let p=null;for(const t of a){const e=o.attributes[`${"entfernt"===t||"geerntet"===t?t:t+"_beginn"}`];if(e){p=new Date(e);break}}if(!p)return[];if(this._imagesList.forEach((t=>{var e;const i=t.url,n=t.date;let r="",h=0,m=0;for(const t of a){const e=o.attributes[`${"entfernt"===t||"geerntet"===t?t:t+"_beginn"}`];if(e){const i=new Date(e);n>=i&&(r=s[t],h=Math.floor((n.getTime()-i.getTime())/864e5))}}if(m=Math.floor((n.getTime()-p.getTime())/864e5),r){if(r!==d){if(c.length>0){const t=(null===(e=Object.entries(s).find((([t,e])=>e===d)))||void 0===e?void 0:e[0])||"",i=u.indexOf(t);let n="var(--primary-color)";n="geerntet"===t?"repeating-linear-gradient(45deg, var(--primary-color), var(--primary-color) 10px, var(--dark-primary-color) 10px, var(--dark-primary-color) 20px)":"entfernt"===t?"repeating-linear-gradient(45deg, var(--error-color), var(--error-color) 10px, var(--dark-error-color) 10px, var(--dark-error-color) 20px)":`hsl(var(--hue, 120), var(--saturation, 60%), ${55-i/Math.max(1,u.length-1)*25}%)`,l.push({phase:d,images:c,color:n})}d=r,c=[]}c.push({url:i,day:h+1,totalDays:m+1})}})),c.length>0){const t=(null===(n=Object.entries(s).find((([t,e])=>e===d)))||void 0===n?void 0:n[0])||"",e=u.indexOf(t);let i="var(--primary-color)";i="geerntet"===t?"repeating-linear-gradient(45deg, var(--primary-color), var(--primary-color) 10px, var(--dark-primary-color) 10px, var(--dark-primary-color) 20px)":"entfernt"===t?"repeating-linear-gradient(45deg, var(--error-color), var(--error-color) 10px, var(--dark-error-color) 10px, var(--dark-error-color) 20px)":`hsl(var(--hue, 120), var(--saturation, 60%), ${55-e/Math.max(1,u.length-1)*25}%)`,l.push({phase:d,images:c,color:i})}return l}_getImageDate(t){var e,i,n,r;const o=this._imagesList.find((e=>e.url===t));if(!o)return"Datum unbekannt";const a=o.date,s=a.toLocaleDateString("de-DE",{weekday:"short",year:"numeric",month:"2-digit",day:"2-digit",hour:"2-digit",minute:"2-digit"});if(!(null===(n=null===(i=null===(e=this._plantInfo)||void 0===e?void 0:e.helpers)||void 0===i?void 0:i.growth_phase)||void 0===n?void 0:n.entity_id))return s;const l=this._plantInfo.helpers.growth_phase.entity_id,d=null===(r=this.hass)||void 0===r?void 0:r.states[l];if(!d)return s;const c=["samen","keimen","wurzeln","wachstum","blüte","geerntet","entfernt"],u={samen:"Samen",keimen:"Keimen",wurzeln:"Wurzeln",wachstum:"Wuchs",blüte:"Blüte",geerntet:"Geerntet",entfernt:"Entfernt"};let p="",h=0,m=0,g=null;for(const t of c){const e=d.attributes[`${"entfernt"===t||"geerntet"===t?t:t+"_beginn"}`];if(e){g=new Date(e);break}}for(const t of c){const e=d.attributes[`${"entfernt"===t||"geerntet"===t?t:t+"_beginn"}`];if(e){const i=new Date(e);a>=i&&(p=u[t],h=Math.floor((a.getTime()-i.getTime())/864e5))}}if(g&&(m=Math.floor((a.getTime()-g.getTime())/864e5)),0===this.images.indexOf(t)){let t=`<div class="date-line">${s}</div>`;return t+=`<div class="info-line">Tag 1 <span class="phase">${p}</span>/1 Total</div>`,t}let f=`<div class="date-line">${s}</div>`;return f+=`<div class="info-line">Tag ${h+1} <span class="phase">${p}</span>/${m+1} Total</div>`,f}render(){return o.html`
        ...
        `}}e.FlowerGallery=c,n([(0,a.property)()],c.prototype,"hass",void 0),n([(0,a.property)()],c.prototype,"entityId",void 0),n([(0,a.property)({type:Array})],c.prototype,"images",void 0),n([(0,a.property)()],c.prototype,"onClose",void 0),n([(0,a.property)()],c.prototype,"getImageDate",void 0),n([(0,a.property)({type:Number})],c.prototype,"initialImageIndex",void 0),n([(0,a.state)()],c.prototype,"_currentImageIndex",void 0),n([(0,a.state)()],c.prototype,"_isFading",void 0),n([(0,a.state)()],c.prototype,"_showFlyout",void 0),n([(0,a.state)()],c.prototype,"_showDeleteFlyout",void 0),n([(0,a.state)()],c.prototype,"_showMainImageFlyout",void 0),customElements.get("brokkoli-gallery")||customElements.define("brokkoli-gallery",c)},242:function(t,e,i){var n=this&&this.__decorate||function(t,e,i,n){var r,o=arguments.length,a=o<3?e:null===n?n=Object.getOwnPropertyDescriptor(e,i):n;if("object"==typeof Reflect&&"function"==typeof Reflect.decorate)a=Reflect.decorate(t,e,i,n);else for(var s=t.length-1;s>=0;s--)(r=t[s])&&(a=(o<3?r(a):o>3?r(e,i,a):r(e,i))||a);return o>3&&a&&Object.defineProperty(e,i,a),a},r=this&&this.__awaiter||function(t,e,i,n){return new(i||(i=Promise))((function(r,o){function a(t){try{l(n.next(t))}catch(t){o(t)}}function s(t){try{l(n.throw(t))}catch(t){o(t)}}function l(t){var e;t.done?r(t.value):(e=t.value,e instanceof i?e:new i((function(t){t(e)}))).then(a,s)}l((n=n.apply(t,e||[])).next())}))};Object.defineProperty(e,"__esModule",{value:!0}),e.PlantCreateDialog=void 0;const o=i(437),a=i(924),s=customElements.get("plant-create-dialog");class l extends o.LitElement{constructor(){super(...arguments),this.position={x:0,y:0}}closeDialog(){this.dispatchEvent(new CustomEvent("dialog-closed"))}createPlant(t){return r(this,void 0,void 0,(function*(){if(t.preventDefault(),!this.hass)return;const e=new FormData(t.target),i={};e.forEach(((t,e)=>{""!==t&&(i[e]=t)}));try{const t=yield this.hass.callWS({type:"call_service",domain:"plant",service:"create_plant",service_data:i,return_response:!0});if(t&&t.response){const{entity_id:e,device_id:i}=t.response;e&&i&&(yield this._setPositionAndArea(e,i,this.position,this.areaId))}this.closeDialog()}catch(t){}}))}_setPositionAndArea(t,e,i,n){return r(this,void 0,void 0,(function*(){if(this.hass)try{if(this.dispatchEvent(new CustomEvent("plant-created",{bubbles:!0,composed:!0,detail:{entity_id:t,device_id:e,position:i,area_id:n}})),n){const t=n.toLowerCase().replace(/ä/g,"a").replace(/ö/g,"o").replace(/ü/g,"u").replace(/ß/g,"ss");yield this.hass.callService("plant","move_to_area",{device_id:[e],area_id:t})}}catch(t){}}))}render(){return this.hass?o.html`
...
`},265:(t,e,i)=>{Object.defineProperty(e,"__esModule",{value:!0}),e.BrokkoliListComponents=void 0;const n=i(437),r=i(598),o=i(442);e.BrokkoliListComponents=class{static renderHeader(t){return""===t?n.html``:n.html`
        ...
        `}static renderToolbar(t,e,i,r,o,a,s,l){var d,c,u,p,h,m,g;return(null===(d=null==t?void 0:t.multiselect)||void 0===d?void 0:d.enabled)||(null===(c=null==t?void 0:t.search)||void 0===c?void 0:c.enabled)||(null===(u=null==t?void 0:t.filter)||void 0===u?void 0:u.enabled)?n.html`
            <div class="toolbar">
        ...
        `}static renderTableRow(t,e,i,r,o,a,s,l,d){return n.html`
            <tr>
                ${i?n.html`
                    <td>
                        <input 
        ...
        `}}},358:(t,e,i)=>{Object.defineProperty(e,"__esModule",{value:!0}),e.CellRenderer=void 0;const n=i(437),r=i(289),o=i(442),a=i(70),s=i(869);e.CellRenderer=class{static renderCell(t){const{hass:e,plant:i,columnId:n,editingCell:r,onCellClick:o,onInputUpdate:a,onRowClick:s}=t,l=i.entity_id.split(".")[1],d={hass:e,plant:i,columnId:n,onInput:(t,e)=>a(t,e),onClick:o,onRowClick:s};return(null==r?void 0:r.entityId)===i.entity_id&&(null==r?void 0:r.column)===n?this.renderEditingCell(l,n,e,d):this.renderNormalCell(l,n,e,i,d)}static renderEditingCell(t,e,i,o){const s=o.plant,l=t=>{if(s.attributes._sensorMap&&s.attributes._sensorMap[t])return s.attributes._sensorMap[t]};if(r.CellTypeUtils.isDateInput(e)){const t=l("growth_phase");if(!t)return n.html`<span>Sensor-Map fehlt</span>`;const r=null==i?void 0:i.states[t];return a.TemplateUtils.renderDateInput(null==r?void 0:r.attributes[e],o)}if(r.CellTypeUtils.isDurationInput(e)){const t=l("growth_phase");if(!t)return n.html`<span>Sensor-Map fehlt</span>`;const r=null==i?void 0:i.states[t];return a.TemplateUtils.renderNumberInput(null==r?void 0:r.attributes[e],"Tage",o,1)}if(r.CellTypeUtils.isNumberInput(e)){const t=l(e);if(!t)return n.html`<span>Sensor-Map fehlt</span>`;const r=null==i?void 0:i.states[t],s=this.getNumberInputUnit(e,r);return a.TemplateUtils.renderNumberInput(null==r?void 0:r.state,s,o)}return r.CellTypeUtils.isSelectInput(e)?this.renderSelectInput(e,t,i,o):r.CellTypeUtils.isTextInput(e)||r.CellTypeUtils.isTextArea(e)?a.TemplateUtils.renderTextInput(o.plant.attributes[e],o,r.CellTypeUtils.isTextArea(e)):n.html``}static renderNormalCell(t,e,i,o,l){const d=(0,s.getFieldDefinition)(e);if(r.CellTypeUtils.isDateInput(e))return this.renderDateValue(t,e,i,l);if(r.CellTypeUtils.isDurationInput(e)){let t;if(o.attributes._sensorMap&&o.attributes._sensorMap.growth_phase){const r=o.attributes._sensorMap.growth_phase;t=null==i?void 0:i.states[r];const a=null==t?void 0:t.attributes[e];return n.html`
                    <span @click=${l.onClick}>
                        ${a?`${a} Tage`:"-"}
                    </span>
                `}return n.html`<span @click=${l.onClick}>-</span>`}if((null==d?void 0:d.isSensor)&&d.showStatusBar)return a.TemplateUtils.renderSensorCell(l);if((null==d?void 0:d.isSensor)&&!d.showStatusBar){let t;if(o.attributes._sensorMap&&o.attributes._sensorMap[e]){const r=o.attributes._sensorMap[e];return t=null==i?void 0:i.states[r],n.html`
                    <span @click=${l.onClick}>
                        ${t?`${t.state} ${t.attributes.unit_of_measurement||d.unit||""}`:"-"}
                    </span>
                `}return n.html`<span @click=${l.onClick}>-</span>`}switch(e){case"friendly_name":return a.TemplateUtils.renderPlantName(o.attributes.friendly_name,o.attributes.entity_picture,l);case"state":return a.TemplateUtils.renderBadge(o.state,l,"status");case"cycle":return this.renderCycleValue(t,o,i,l);case"area":return this.renderAreaValue(o,i,l);case"growth_phase":return this.renderGrowthPhaseValue(t,i,l);case"pot_size":case"flowering_duration":return this.renderMeasurementValue(t,e,i,l);case"website":return a.TemplateUtils.renderWebsiteCell(o.attributes.website,l,!1);default:return this.renderDefaultValue(e,o,l)}}static getNumberInputUnit(t,e){return"flowering_duration"===t?"Tage":"pot_size"===t?"L":(null==e?void 0:e.attributes.unit_of_measurement)||""}static renderSelectInput(t,e,i,n){var s;let l,d=[];const c=n.plant;if("growth_phase"===t){if(c.attributes._sensorMap&&c.attributes._sensorMap.growth_phase){const t=c.attributes._sensorMap.growth_phase,e=null==i?void 0:i.states[t];d=r.CellTypeUtils.getGrowthPhaseOptions(i,c),l=null==e?void 0:e.state}}else if("cycle"===t){if(c.attributes._sensorMap&&c.attributes._sensorMap.cycle){const t=c.attributes._sensorMap.cycle,e=null==i?void 0:i.states[t];d=r.CellTypeUtils.getCycleOptions(i,c),l=null==e?void 0:e.state}}else if("area"===t){const t=o.FilterUtils.getAreaForEntity(i,n.plant.entity_id);l=t?null===(s=null==i?void 0:i.areas[t])||void 0===s?void 0:s.name:"",d=r.CellTypeUtils.getAreaOptions(i)}return a.TemplateUtils.renderSelectInput(l,d,n,`${t}-select`)}static renderDateValue(t,e,i,r){const o=r.plant;if(o.attributes._sensorMap&&o.attributes._sensorMap.growth_phase){const t=o.attributes._sensorMap.growth_phase,a=null==i?void 0:i.states[t],s=null==a?void 0:a.attributes[e];if(s){const t=new Date(s);return n.html`
        ...
        `}static renderTextInput(t,e,i=!1){return i?n.html`
            ...
            <input
                ...
                class="text-input"
            >
        `}static renderSensorCell(t){const{hass:e,plant:i,columnId:o}=t,a=r.SensorUtils.getSensorInfo(e,i,o),s=r.SensorUtils.getSensorThresholds(e,i,o),l=100*Math.max(0,Math.min(1,(a.value-s.min)/(s.max-s.min))),d=r.SensorUtils.calculateSensorStatus(a.value,s.min,s.max);return n.html`
            <div class="sensor-cell" @click=${t.onClick}>
                <div class="meter-container">
                    ...
                    <div class="meter red">
                        <span class="bad" style="width:${"unavailable"!==d&&a.value>s.max?100:0}%;"></span>
                    </div>
                </div>
