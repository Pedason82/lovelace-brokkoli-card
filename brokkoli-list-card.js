                    ...
                    <div class="gallery-header">
                        ...
                        <div class="gallery-header-buttons">
                            ...
                            <div class="treatment-container">
                                ...
                                ${this._showTreatmentPanel?r.html`
                                    <div class="treatment-panel">
                                        ...
                                        <div class="treatment-section">
                                            ...
                                            >
                                                ...
                                                ${this._getTreatmentOptions().map((t=>r.html`<option value="${t}" ?selected="${this._applyTreatment===t}">${t}</option>`))}
                                            </select>
                                            <button
                                        ...
                                        <div class="treatment-section">
                                            ...
                                            >
                                                <option value="">Wählen...</option>
                                                ${this._getTreatmentOptions().map((t=>r.html`<option value="${t}" ?selected="${this._selectedTreatment===t}">${t}</option>`))}
                                            </select>
                                            <button
