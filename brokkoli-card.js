                        ...
                        <div class="gallery-header-buttons">
                            ...
                            ${this.images.length>0?a.html`
                                <div class="flyout-container ${this._showMainImageFlyout?"open":""} ${this._showDeleteFlyout?"delete-open":""}">
                                    ...
                                    <div class="flyout-menu">
                                        <ha-icon-button
                                            @click="${()=>s(this,void 0,void 0,(function*(){const t=this.images[this._currentImageIndex].split("/").pop();if(t)try{yield this._setMainImage(t),this._showMainImageFlyout=!1}catch(t){alert("Fehler beim Setzen des Hauptbildes: "+t.message)}}))}"
                                            class="confirm-main"
                        ...
                        <div class="phase-content add-content">
                            ${null!==this._selectedAddAction?a.html`
                                ...
                                <div class="form-content" @click=${t=>t.stopPropagation()}>
                                    ...
                                    ${this._selectedAddAction!==D&&this._selectedAddAction!==A&&this._selectedAddAction!==P&&this._selectedAddAction!==S&&this._selectedAddAction!==T?a.html`
                                    ...
                                    <div class="add-menu-options">
                                        ...
                                        ${i.includes(e.EVENT_TYPES.TREATMENT)?a.html`
                                            <div class="add-option" data-action="${P}" @click=${t=>{t.stopPropagation(),this._selectAddAction(P)}}>
                                                <ha-icon icon="mdi:medical-bag" class="option-icon" style="color: hsl(${_}, ${b}%, 45%);"></ha-icon>
